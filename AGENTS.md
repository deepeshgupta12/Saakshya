...
This project is indexed by GitNexus as **Saakshya** (6130 symbols, 10697 relationships, 170 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
